...
let
  python3' = python3.override {
    packageOverrides = final: prev: {
      # https://github.com/icosa-foundation/icosa-gallery/blob/c7d987fa17713ea575c12df6b73d46f1d2e93058/django/requirements.in#L27
...
python3Packages.buildPythonApplication rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "icosa-gallery";
    rev = "c7d987fa17713ea575c12df6b73d46f1d2e93058";
    hash = "sha256-vUEhbJnmDB38tvTBKiNg41Jmz/kTwb/FfqxRGKRFgZI=";
  };
