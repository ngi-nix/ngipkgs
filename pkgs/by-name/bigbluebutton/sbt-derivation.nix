...
let
  ...
  bbb-freeswitch-sounds =
    ...
    stdenv.mkDerivation (finalAttrs: {
      ...
      meta = sharedBbbThings.meta // {
        description = sharedBbbThings.meta.description + " (bbb-freeswitch-sounds)";
      };
    });

  bbb-fsesl-client = mkSbtDerivation {
    ...
    meta = sharedBbbThings.meta // {
      description = sharedBbbThings.meta.description + " (bbb-fsesl-client)";
    };
  };

  bbb-fsesl-akka = mkSbtDerivation {
    ...
    meta = sharedBbbThings.meta // {
      description = sharedBbbThings.meta.description + " (bbb-fsesl-akka)";
    };
  };
