...
lib.extendMkDerivation {
  ...
  extendDrvArgs =
    ...
    let
      mixNixDeps =
        # When `mixNixDeps` is generated by a `callPackage`
        # it introduces `override` and `overrideDerivation` attributes
        # which do not have a `name` and must be excluded.
        lib.filterAttrs (n: v: v ? "name") (finalAttrs.passthru.mixNixDeps or initAttrs.mixNixDeps or { });
