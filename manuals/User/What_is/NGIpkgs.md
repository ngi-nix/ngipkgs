...
- `services` recipes
in [Nix-the-language](https://nix.dev/tutorials/nix-language.html)
to use those softwares inside a Nix configuration management framework
...
are for softwares funded by the [Next Generation Internet](https://www.ngi.eu) (NGI) initiative
