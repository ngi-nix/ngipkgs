(Contributor_Why_to_document_with_many_files)=
# Why to document with many files?

(Contributor_Why_to_document_with_many_files.Pros)=
## Pros
...
(Contributor_Why_to_document_with_many_files.Cons)=
## Cons
- Requires a lot of `{toctree}
