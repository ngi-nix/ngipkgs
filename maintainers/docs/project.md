...
- Use `module` for the application configuration and `module-demo` for demo-specific things, like [demo-shell](https://github.com/eljamm/ngipkgs/blob/main/overview/demo/shell.nix).
