# How to maintain compatibility of a module when an option's `name` is changed {#Contributor_How_to_maintain_compatibility_of_a_module_when_an_option_s_name_is_changed}
