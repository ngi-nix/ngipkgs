# How to maintain compatibility of a module when an option's `type` is changed {#Contributor_How_to_maintain_compatibility_of_a_module_when_an_option_s_type_is_changed}
