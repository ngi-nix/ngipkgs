# Why to develop a package using Elixir {#Contributor_Why_to_develop_a_package_using_Elixir_with_deps_nix}

## Pros {#Contributor_Why_to_develop_a_package_using_Elixir_with_deps_nix.Pros}
_ Like `mix2nix`, `deps_nix` enables to use separate Nix derivations for each dependency
...
## Cons {#Contributor_Why_to_develop_a_package_using_Elixir_with_deps_nix.Cons}
