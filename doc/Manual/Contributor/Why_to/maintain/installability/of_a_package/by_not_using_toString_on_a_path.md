# Why to maintain installability of a package by not using `toString` on a `path` {#Contributor_Why_to_maintain_installability_of_a_package_by_not_using_toString_on_a_path}
