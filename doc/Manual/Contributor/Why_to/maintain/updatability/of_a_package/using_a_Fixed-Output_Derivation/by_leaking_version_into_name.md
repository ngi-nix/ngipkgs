# Why to maintain updatability of a package by leaking `version` into the `name` of a Fixed-Output Derivation {#Contributor_Why_to_maintain_updatability_of_a_package_using_a_Fixed-Output_Derivation_by_leaking_version_into_name}

## Without leaking `version` {#Contributor_Why_to_maintain_updatability_of_a_package_using_a_Fixed-Output_Derivation_by_leaking_version_into_name.Without_leaking_version}
...
## With leaking `version` {#Contributor_Why_to_maintain_updatability_of_a_package_using_a_Fixed-Output_Derivation_by_leaking_version_into_name.With_leaking_version}
