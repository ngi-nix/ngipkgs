...
rec {
  /**
      ...
      1. [Run the overview locally](https://github.com/ngi-nix/ngipkgs/blob/docs/render/CONTRIBUTING.md#running-and-testing-the-overview-locally), navigate to the project page and make sure that the options and examples shows up correctly

      1. [Make a Pull Request on GitHub](https://github.com/ngi-nix/ngipkgs/blob/docs/render/CONTRIBUTING.md#how-to-create-pull-requests-to-ngipkgs)
  */
  project =
    { name, ... }:
    {
