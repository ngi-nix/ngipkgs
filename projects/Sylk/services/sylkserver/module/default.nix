...

{
  ...
  config = lib.mkIf cfg.enable {
    ...
    // lib.optionalAttrs (cfg.stateDir != "/var/lib/sylkserver") {
      "10-sylkserver"."${cfg.stateDir}".d = {
        group = cfg.group;
        user = cfg.user;
        mode = "075";
      };
    ...
    systemd.services.sylkserver = {
      ...
      serviceConfig = {
        ...
        StateDirectory = lib.optionalString (cfg.stateDir == "/var/lib/sylkserver") "sylkserver";
        Restart = "on-failure";
        RestartSec = 5;
      };
      unitConfig = {
    ...
    networking.firewall = lib.mkIf cfg.openFirewall {
      ...
      allowedTCPPortRanges = [
        (
          let
            portRange = lib.splitString ":" cfg.settings.config.RTP.port_range;
          in
          {
