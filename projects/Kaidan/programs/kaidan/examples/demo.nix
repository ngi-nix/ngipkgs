...
let
  ...
  # User JIDs to be used to login to Kaidan
...
in
{
  ...
  # Install SPICE guest agent for better display integration
  services.spice-vdagentd.enable = true;

  # Set up local XMPP server: prosody
  ...
  services.prosody = {
    ...
    # Ensure certificates are in the expected dir
    extraConfig = ''
