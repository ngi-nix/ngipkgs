{
  ...
  outputs =
    ...
    let
      ...
      eachDefaultSystemOutputs = flake-utils.lib.eachDefaultSystem (system:
        let
      ...
      x86_64-linuxOutputs =
        ...
        in
        {
          # What to build when running `nix flake check`
          # See `.github/workflows/ci.yaml` for where GitHub Actions are triggered.
          checks.${system} =
            let
