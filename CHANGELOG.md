...
- *Kazarma* Replace template placeholder name with "Kazarma"
- *demo* Skip forwarding privileged ports
- *mcaptcha* Rename meta.url to meta.homepage, add meta.teams
...
- Small cleanup
- Add meta.homepage and meta.teams
...
- *makemake* Reduce nix-eval-jobs workers count (#2252)
